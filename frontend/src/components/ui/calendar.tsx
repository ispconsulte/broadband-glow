    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-secondary/50 border-border/20 p-0 opacity-70 hover:opacity-100 hover:bg-secondary",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-secondary/80 rounded-lg transition-colors"),
        ...
        day_today: "bg-accent/60 text-accent-foreground font-semibold rounded-lg",
        day_outside:
